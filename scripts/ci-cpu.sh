...
#   - start the dictate daemon
#   - touch DISPLAY / GNOME / live X
#   - GPU soak / nvidia-smi
#   - download ASR models or run e2e decode
#
# Provider coverage comes from unit tests in dictate-core (config + Transcriber
...
CACHE_ROOT="${SHERPA_ONNX_CACHE_DIR:-${XDG_CACHE_HOME:-$HOME/.cache}/dictate/sherpa-onnx-cpu}"
